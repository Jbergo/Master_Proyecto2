...
const videogamesFilter = videogames.filter((game) =>
  game.genders.find((game) => game === "RPG"),
);

const videoGamesMedia =
  videogamesFilter.reduce((acc, curr) => acc + curr.score, 0) /
  videogamesFilter.length;
