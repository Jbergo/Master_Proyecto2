...
const notas = exams.reduce((acc, curr) => acc + curr.score, 0);
console.log(notas);
console.log("----------");
...
const notasAprobadas = exams.reduce((acc, curr) => {
  if (curr.score >= 5) {
...
*/
const notasMedia = exams.reduce((acc, curr) => acc + curr.score, 0);
const notasMediaFinal = notasMedia / exams.length;

console.log(notasMediaFinal);
