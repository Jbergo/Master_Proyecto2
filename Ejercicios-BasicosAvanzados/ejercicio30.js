...
const tracksClassification = {};

for (const track of tracks) {
  let genre = track.genre;

  if (!tracksClassification[genre]) {
    tracksClassification[genre] = [];
  }

  tracksClassification[genre].push(track);
}

console.log(tracksClassification);
